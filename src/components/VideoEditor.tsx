...
export default function VideoEditor({
  ...
  const getExportUrl = () => {
    if (markIn !== null && markOut !== null && markOut > markIn && publicId) {
      ...
      return `https://res.cloudinary.com/${cloudName}/video/upload/so_${so},eo_${eo}/${publicId}.mp4`;
    }
    return null;
  };
    ...
    if (url) {
      ...
      const duration =
        markIn !== null && markOut !== null
          ...
          : "unknown";
      a.download = `subclip_${markIn?.toFixed(2)}s_to_${markOut?.toFixed(2)}s_duration_${duration}s.mp4`;
